...
"Does not support Fusions right now."))
        ...
        self.actionCreate_Reset_Local_Database.setText(_translate("MainMenu", "Reset Database (Restart Required)"))
        self.actionCreate_Database_Tables.setText(_translate("MainMenu", "Create Database Tables (Restart Required)"))
